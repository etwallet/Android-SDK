...
import com.eostoken.opensdk.kylin.model.KylinContract;
import com.eostoken.opensdk.kylin.model.KylinLogin;
import com.eostoken.opensdk.kylin.model.KylinPay;
import com.eostoken.opensdk.kylin.model.KylinResult;
import com.eostoken.opensdk.kylin.model.KylinSign;
...
public class KylinManager {
    ...
    public void pay(Context context, KylinPay pay, KylinCallback callback) {
        ...
        pullUpET(context, KylinConstant.KYLIN_PAY, new Gson().toJson(pay));
    }
    ...
    public void login(Context context, KylinLogin login, KylinCallback callback) {
        this.mKylinCallback = callback;
        pullUpET(context, KylinConstant.KYLIN_LOGIN, new Gson().toJson(login));
    }
    ...
    public void sign(Context context, KylinSign sign, KylinCallback callback) {
        this.mKylinCallback = callback;
        pullUpET(context, KylinConstant.KYLIN_SIGN, new Gson().toJson(sign));
    }
    ...
    public void contract(Context context, KylinContract contract, KylinCallback callback) {
        this.mKylinCallback = callback;
        pullUpET(context, KylinConstant.KYLIN_CONTRACT, new Gson().toJson(contract));
    }
    ...
    public void parseIntent(Intent intent) {
        ...
        //Base64 解密
        params = ETUtil.base64Decode(params);
        //解析常规的字段
     ...
     * 拉起ET
     */
    private void pullUpET(Context context, String protocol, String params) {
        ...
        try {
            ...
            if (mKylinCallback != null) {
                mKylinCallback.callback(null,
                        new KylinResult(-1, "Please install ET or upgrade to the latest version"));
            }
        }
    }
    ...
    private Uri getParamUri(String protocol, String params) {
        //将param encode处理
        String temp = protocol + "?params=" + ETUtil.base64Encode(params);
